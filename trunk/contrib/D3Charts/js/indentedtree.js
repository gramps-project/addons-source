...
d3.json("json/indentedtree.json", function(error, descendant) {
 descendant.x0 = 0;
 descendant.y0 = 0;
...
function update(source) {
 ...
 nodeEnter.append("rect")
  ...
  .attr("width", function(n) { return width - n.y;})
  .style("fill", color)
  .on("click", click);
 ...
 nodeEnter.append("text")
  ...
  .attr("dx", textMargin)
  .text(function(d) {
    var ret_str = d.display_num + " " + d.name + " (" + d.born + " - " + d.died + ")";    if (d.display_num == "sp.") {
