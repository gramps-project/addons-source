...
class PrerequisitesCheckerGramplet(Gramplet):
    ...
    def init(self):
        ...
        thread = Thread(target=latest_version_thread, args=(self,), daemon=True)
        thread.start()
        self.has_run = False
    ...
    def main(self):
        ...
        self.append_text(
            _(
                "If you have a reason to be checking Prerequisites,"
        ...
        self.append_text(
            _(
                " • Backups can be made at any time and, at a minimum, on "
                "the first day of every month. But preferrably more often.\n"
            )
        )
        self.append_text(
            _(
                " • It is strongly recommended to backup each"
                " of your Family Trees before any upgrade.\n"
            )
        )
        self.append_text(
            _(
                " • Test your backups by creating a new Family Tree "
    ...
    def gramps_version(self):
        ...
        if not gramps_ver >= self.latest_gramps_version:
            ...
            ) % (gramps_str, latest_release_message)
        else:
            if not gramps_ver == self.latest_gramps_version:
                result = _(
                    "You have Gramps %s installed; an unreleased "
                ...
                result = _(
                    "You have Gramps %s. Congratulations, you have the"
                    " current version.\n"
                ) % (gramps_str)
    ...
    def check10_languagepackgnomexx(self):
        ...
        result = _(
            " • language-pack-gnome-xx (Manual check see instructions "
    ...
    def check12_graphviz(self):
        ...
        try:
            dotversion_str = Popen(["dot", "-V"], stderr=PIPE).communicate(input=None)[
                1
            ]
        ...
        *Number of Vertical Pages: (1 default) Graphviz can create very large
        ...
        try:
            if win():
                ...
                gsvers_str = Popen(["gs", "--version"], stdout=PIPE).communicate(
                    input=None
                )[0]
    ...
    def check_fontconfig(self):
        ...
        try:
            ...
            if vers.startswith("0.5."):
                ...
                result = " • python-fontconfig " + vers + _(" (Requires version 0.5.x)")
        except ImportError:
    ...
    def check16_rcs(self):
        ...
        if _RCS_FOUND:  # TODO actually test for version
            result = _(
                " • rcs %s TBD (Passed: version %s or greater "
                "installed. If not on Microsoft Windows)"
            ) % (RCS_RESULT, rcs_ver_str)
        else:
            result = _(
                " • rcs %s TBD (Requires version %s or greater "
                "installed. If not on Microsoft Windows)"
            ) % (RCS_RESULT, rcs_ver_str)
    ...
    def check23_pedigreechart(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 03. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check24_networkchart(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 04. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check25_genealogytree(self):
        ...
        * PILLOW
        ...
        self.append_text("\n")
        self.render_text(
            """ 05. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check26_htmlview(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 06. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check27_googlemapkml(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 07. <b><a href="https://gramps-project.org/wiki"""
        ...
        if os.sys.platform == "win32":
            ...
            if not _GOOGLEEARTH_OK:
                ...
                NORM_PATH = os.path.normpath(FILE_PATH)
                _GOOGLEEARTH_OK = search_for(NORM_PATH)
                _GOOGLEEARTH_STATUS = _(
                    "Standard. Passed: program installed -" " 32bit on 64bit Win OS."
                )
        ...
        result = (
            """(<a href="https://www.google.com/earth/desktop/">"""
    ...
    def check28_webconnectpacks(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 08. <b><a href="https://gramps-project.org/wiki/"""
    ...
    def check29_tmgimporter(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 09. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check30_PostgreSQL(self):
        ...
        self.append_text("\n")
        self.render_text(
            """ 10. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check31_EditExifMetadata(self):
        ...
        * exiv2
        ...
        self.append_text("\n")
        self.render_text(
            """ 11. <b><a href="https://gramps-project.org/"""
    ...
    def check32_phototagginggramplet(self):
        ...
        * python-numpy package.
        ...
        self.append_text("\n")
        self.render_text(
            """ 12. <b><a href="https://gramps-project.org/wiki"""
    ...
    def check33_lxmlgramplet(self):
        ...
        * lxml is a Pythonic binding for the C libraries libxml2 and libxslt.
        ...
        self.append_text("\n")
        self.render_text(
            """ 13. <b><a href="https://www.gramps-project.org/"""
        ...
        if LXML_OK:
            ...
            result = (
                ...
                + verstr(LXML_VERSION)
                + ")(libxml: "
                + verstr(LIBXML_VERSION)
                + ")(libxslt: "
                + verstr(LIBXSLT_VERSION)
                + ")"
            )
        else:
            # print("Failed")
            result = (
                _(" (lxml: not found. Requires version ")
                + REQ_LXML_VERSION
                + _(" or greater installed.)")
            )
        # End checks
    ...
    def check34_mongodb(self):
        ...
        * MongoDB
        ...
        self.append_text("\n")
        self.render_text(
            """ 14. <b><a href="https://www.gramps-project.org/"""
    ...
    def locale_settings(self):
        ...
        self.render_text(
            _(
                """<u><b><a href="https://gramps-project.org/wiki"""
    ...
    def sphinx_check(self):
        ...
        self.append_text(
            _(
                "Sphinx is a tool that builds the Gramps "
