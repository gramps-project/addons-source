...
class DescendantIndentedTreeReport(Report):
    ...
    def write_report(self):
        ...
        # Generate indentedtree.js based on colors and initial
        # generations to display
        try:
            dest_js = os.path.join(self.destpath, "js", "indentedtree.js")
            with io.open(dest_js, 'w', encoding='utf8') as fp:
                ...
                fp.write('d3.json("json/indentedtree.json", ' +
        ...
        try:
            dest_json = os.path.join(self.destpath, "json", "indentedtree.json")
