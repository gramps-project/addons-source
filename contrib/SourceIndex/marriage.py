...
class MarriageIndex(tool.Tool, ManagedWindow):
    def __init__(self, dbstate, uistate, options_class, name, callback=None):
        ...
        #AttributeError: 'MarriageIndex' object has no attribute 'top'
        ...
        # tests
        filename = os.path.join(USER_PLUGINS, 'SourceIndex', 'test_marriage.xml')
        self.write_xml(
            filename,
            'M0001',
            'DATE'
...
class MarriageIndexOptions(tool.ToolOptions):
    """
