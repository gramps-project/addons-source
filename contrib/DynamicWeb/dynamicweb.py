...
#TODO: Save as button for graphs
...
SVG_TREES = [
	_("Ascending tree (horizontal)"),
	_("Ascending tree (vertical)"),
	...
	_("Descending tree (horizontal)"),
	_("Descending tree (horizontal, with spouses)"),
	_("Descending tree (vertical)"),
	_("Descending tree (vertical, with spouses)"),
	...
	_("Ascending and descending tree (horizontal)"),
	_("Ascending and descending tree (horizontal, with spouses)"),
	_("Ascending and descending tree (vertical)"),
	_("Ascending and descending tree (vertical, with spouses)"),
...
class DynamicWebOptions(MenuReportOptions):
	...
	def __add_trees_options(self, menu):
		...
		svg_tree_type = EnumeratedListOption(_("SVG tree graph type"), str(DEFAULT_SVG_TREE))
