...
WEBSITES = [
    ["Person", u"Ministère de la culture", _("French cultural ministry"), u"http://www.culture.fr/genealogie/?action_type=search&lang=fr&search_nom=%(surname)s&search_prenom=%(given)s"],
    ["Person", "Geneabank", _("Genealogical bank"), u"http://searchgbk.geneanet.org/result.php3?name=%(surname)s&place=&start=&end=&source=gbk*"],
    ...
    ["Person", "Fichier Origine", _("OrigineFile (Quebec)"), u"http://www.fichierorigine.com/recherche.php?nom=%(surname)s"],
    ["Person", "Geneanet", "Geneanet", u"http://search.geneanet.org/result.php?lang=fr&name=%(surname)s"],
    ["Person", "Geneanet-Favrejhas", "Geneanet, Favrejhas", u"http://gw1.geneanet.org/index.php3?b=favrejhas&m=NG&n=%(surname)s&t=N&x=0&y=0"],
    ["Person", "Roglo", "Roglo", u"http://roglo.eu/roglo?m=NG&n=%(given)s+%(surname)s&t=PN"],
    ...
    ["Person", "CAILGEO", _("Cyber genealogy"), u"http://www.cybergenealogie.fr/cailgeo/fr/cail01n.php?nomr=%(surname)s"],
    ["Person", "Gallica", "Gallica", u'''http://gallica.bnf.fr/Search?ArianeWireIndex=index&p=1&lang=FR&q="%(surname)s,+%(given)s"'''],
    ...
    ["Person", "Google Archives", _("Google Archives"), u"http://news.google.fr/archivesearch?q=%(surname)s&btnGt=Afficher+la+chronologie"],
