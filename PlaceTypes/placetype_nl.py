...
def translate_func(ptype, locale=None):
    """
    ...
    try:
        _r_trans = glocale.get_addon_translator(
            __file__, languages=(locale.lang, ))
    except ValueError:
...
DATAMAP = {
    ...
    "Country" :         (_T_("Country"), "Country",
                         "#FFFF00000000", P_G(P_G.COUNTRY), None),
    "nl_Province" :     (_T_("nl|Province"), "Provincie",
                         "#0000FFFFFFFF", P_G(P_G.REGION), translate_func),
    "nl_Municipality" : (_T_("nl|Municipality"), "Gemeente",
                         "#0000FFFFFFFF", P_G(P_G.REGION), translate_func),
    "nl_City" :         (_T_("nl|City"), "Stad",
                         "#0000FFFF0000", P_G(P_G.PLACE), translate_func),
    "nl_Place" :        (_T_("nl|Place"), "Plaats",
                         "#0000FFFF0000", P_G(P_G.PLACE), translate_func),
    "nl_Village" :      (_T_("nl|Village"), "Dorp",
                         "#0000FFFF0000", P_G(P_G.PLACE), translate_func),
}
