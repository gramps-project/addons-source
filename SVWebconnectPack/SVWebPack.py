...
WEBSITES = [
    ...
    ["Person", "Gravstensinventeringen - rötter.se", _("Gravestone inventory - rötter.se"), "https://grav.rotter.se/Gravsoklist.php?t2=Gravsok&z_g_lan_id==&x_g_lan_id=&s_x_g_lan_id=&lft_x_g_lan_id=&z_g_kom_id==&x_g_kom_id=&s_x_g_kom_id=&lft_x_g_kom_id=1&z_g_beg_id==&x_g_beg_id=&s_x_g_beg_id=&lft_x_g_beg_id=1&z_fornamn=STARTS+WITH&x_fornamn=%(given)s&y_fornamn=&z_efternamn=STARTS+WITH&x_efternamn=%(surname)s&y_efternamn=&z_fodelsedatum==&x_fodelsedatum=%(birth)s&z_dodsdatum==&x_dodsdatum=%(death)s&z_his_namn=STARTS+WITH&x_his_namn=&y_his_namn=&psearch=&psearchtype1=AND&Submit=Sök"],
    ]
