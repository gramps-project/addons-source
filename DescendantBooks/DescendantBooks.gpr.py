...
register(REPORT,
    id   = 'NEHGRegister',
    name = _('NEHG Register'),
    description = _("Produces New England Historical and Genealogical Register styled detailed descendant report based on a supplied query."),
    version = '0.1.0',
    gramps_target_version = "5.1",
    status = STABLE,
    fname = 'NEHGRegister.py',
    authors = ["Matt Keenan", "Giansalvo Gusinu"],
    authors_email = ["matt.keenan@gmail.com", "giansalvo.gusinu@gmail.com"],
    category = CATEGORY_TEXT,
    reportclass = 'NEHGRegisterReport',
    optionclass = 'NEHGRegisterOptions',
    report_modes = [REPORT_MODE_GUI, REPORT_MODE_BKI, REPORT_MODE_CLI],
    require_active = True
    )
