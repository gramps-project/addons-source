...
class source(GeneratedsSuper):
    member_data_items_ = [
        ...
        MemberSpec_('noteref', 'noteref', 1),
        MemberSpec_('objref', 'objref', 1),
        MemberSpec_('srcattribute', 'srcattribute', 1),
...
class places(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('placeobj', 'placeobj', 1),
    ]
    subclass = None
    superclass = None
...
class repositories(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('repository', 'repository', 1),
    ]
    subclass = None
    superclass = None
...
class citations(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('citation', 'citation', 1),
    ]
    subclass = None
    superclass = None
...
class bookmarks(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('bookmark', 'bookmark', 1),
    ]
    subclass = None
    superclass = None
